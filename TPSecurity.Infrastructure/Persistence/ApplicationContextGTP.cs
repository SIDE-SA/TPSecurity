...
namespace TPSecurity.Infrastructure.Persistence
{
    public partial class ApplicationContextGTP : DbContext
    {
        ...
        public virtual DbSet<AccesApplicationDTO> AccesApplication { get; set; }

        public virtual DbSet<AccesModuleDTO> AccesModule { get; set; }

        public virtual DbSet<AccesFonctionnaliteDTO> AccesFonctionnalite { get; set; }
